    ...
    if type == 'item_standard' then
      ...
      if itemCount > 0 and sourceItem.count >= itemCount then
        if targetXPlayer.canCarryItem(itemName, itemCount) then
          ...
          sendToDiscord("Inventory", GetPlayerName(playerId).. " " ..sourceXPlayer.identifier.. "\n Átadott " ..itemCount.. " db: " ..itemName.. " Neki: " ..GetPlayerName(target))
        else
    ...
    elseif type == 'item_account' then
      if itemCount > 0 and sourceXPlayer.getAccount(itemName).money >= itemCount then
        ...
        targetXPlayer.showNotification(_U('received_account_money', ESX.Math.GroupDigits(itemCount), Config.Accounts[itemName].label,
          sourceXPlayer.name))
        sendToDiscord("Inventory", GetPlayerName(playerId).. " " ..sourceXPlayer.identifier.. "\n Átadott " ..itemCount.. " $: " ..itemName.. " Neki: " ..GetPlayerName(target))
      else
      ...
      if sourceXPlayer.hasWeapon(itemName) then
        ...
        if not targetXPlayer.hasWeapon(itemName) then
          ...
          if weaponObject.ammo and itemCount > 0 then
            ...
            sendToDiscord("Inventory", GetPlayerName(playerId).. " " ..sourceXPlayer.identifier.. "\n Átadott " ..itemCount.. " db lőszerrel: " ..itemName.. " Neki: " ..GetPlayerName(target))
          else
            sourceXPlayer.triggerEvent('esx:giveAnimation')
            targetXPlayer.triggerEvent('esx:giveAnimation')
            ...
            sendToDiscord("Inventory", GetPlayerName(playerId).. " " ..sourceXPlayer.identifier.. "\n Átadott " ..itemCount.. " Neki: " ..GetPlayerName(target))
          end
        else
